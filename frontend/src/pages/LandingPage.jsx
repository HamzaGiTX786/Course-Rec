...
import { FaCheckCircle, FaArrowRight, FaUserFriends, FaRobot, 
        FaClock, FaChartLine, FaCalendarAlt, FaShieldAlt, 
        FaRegClock, FaSearch, FaQuestionCircle } from 'react-icons/fa';
...
export default function LandingPage() {
  ...
  return (
    ...
    <div className="max-w-4xl mx-auto">
        ...
        <FadeInSection>
        <p className="mt-12 text-purple-400 text-xl font-medium">
            That’s why we built <span className="text-white font-bold">CourseRec</span>.
        </p>
        </FadeInSection>
    </div>
    </section>
      ...
      {/* WHY USE COURSEREC SECTION */}
        ...
        <h2 className="text-4xl font-bold mb-4 text-purple-500">Why Use CourseRec?</h2>
        <div className="grid md:grid-cols-3 gap-8 max-w-6xl mx-auto text-left">
            ...
            <FadeInSection key={idx}>
                <div className="bg-gray-700 p-6 rounded-xl shadow hover:ring-2 hover:ring-purple-500 transition-all duration-300">
